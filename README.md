...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rdt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14332&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rdt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rdt` can be installed with:

```
conda install rdt
```

It is possible to list all of the versions of `rdt` available on your platform with:
